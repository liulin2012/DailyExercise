...
//  private String path="http://v.youku.com/player/getRealM3U8/vid/XNjk3NDA1Njgw/type/mp4/v.m3u8";
  private String videoName="";
  private String path = "http://pl.youku.com/playlist/m3u8?keyframe=0&vid="+videoName+"type=mp4";
  private Uri uri;
  ...
  public void onCreate(Bundle icicle) {
    ...
    if (path == "") {
      ...
      path = "http://pl.youku.com/playlist/m3u8?keyframe=0&vid="+videoName+"&type=mp4";
      uri = Uri.parse(path);
