			...
			public void onClick(View arg0) {
				...
				if(dStartDate.after(dNowDate)||s1.equals(s2))
				{
					...
					if(inum != 0){
						...
						{
							Toast.makeText(AddDiyPlanActivity_3.this, "请输入计划名称", Toast.LENGTH_SHORT).show();
						}
						else
						{
							int iReturn;
							...
							if(iReturn == 1)
							{
						        ...
						        Toast.makeText(AddDiyPlanActivity_3.this, "计划添加成功", Toast.LENGTH_SHORT).show();
							}
				        }
					}
					else  //checkbox未选则
					{
						Toast.makeText(AddDiyPlanActivity_3.this, "每周重复中至少选择一天 ", Toast.LENGTH_SHORT).show();
					}
				}
				else
				{
					Toast.makeText(AddDiyPlanActivity_3.this, "无法设定过去的一天为开始锻炼的日期", Toast.LENGTH_SHORT).show();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
				}
			}
		});
	}
