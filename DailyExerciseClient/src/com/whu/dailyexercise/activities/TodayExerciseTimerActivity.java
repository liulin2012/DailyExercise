...
public class TodayExerciseTimerActivity extends Activity {
	...
	class MyCount extends CountDownTimer {  
	    ...
	    public void onFinish() {  
	        ...
	        Toast.makeText(TodayExerciseTimerActivity.this, "倒计时结束",  
	...
	//是否播放音乐和时间
		public void controlExercise()
		{
			...
			if(isPause)
			{
				...
				Toast.makeText(TodayExerciseTimerActivity.this, "开启成功",  
	                    Toast.LENGTH_SHORT).show();  
				isPause=false;
			...
			else
			{
				...
				Toast.makeText(TodayExerciseTimerActivity.this, "关闭成功",  
	                    Toast.LENGTH_SHORT).show();  
				isPause=true;
			}
		}
